...
File: 01_sales_data_analysis.ipynb

Business Focus:
Analyze retail sales data to understand revenue drivers, product performance, and sales trends over time.
...
File: employee_salary_eda.ipynb

Business Focus:
Explore employee salary patterns across departments and experience levels to support compensation and workforce planning decisions.
